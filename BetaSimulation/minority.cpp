...
Minority::Minority(float alpha, float  beta, int xLength, int yLength) : Abstract2DCA(alpha, beta, xLength, yLength)
{
}

QVector<int> Minority::neighbourhood(QPoint i)
{
...
QVector<int> Minority::eigenNeighbourhood(QPoint i)
{
    QVector<int> neighbours(8);
